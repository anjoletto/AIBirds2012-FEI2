...
public class ClientActionRobot {
	...
	public void screenShot(String imageName) {
		try {
			...
			try {
				...
				f = new FileOutputStream(new File(Env.getMatlabDir()
						+ imageName));
				f.write(imageBytes);
				f.close();
	...
	public boolean configureWithResolution() {
		try {
			out.writeObject(new ClientConfigurationWithResolutionCmd(
					"FEI2_Team", "1244768"));
			System.out
					.println(" Using resolution 1244*768. can be set in ClientActionRobot class");
			return in.readBoolean();
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	public boolean configure() {
		try {
			out.writeObject(new ClientConfigurationCmd("FEI2_Team"));
			return in.readBoolean();
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	public Configuration getConfiguration() {
		try {
			out.writeObject(new ClientGetConfCmd("FEI2_Team"));
